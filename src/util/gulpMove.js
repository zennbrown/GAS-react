...
/**
 * Edited by Jazz Brown 2022 for Gas React
 *  // Theres a lot of functionality that is unneeded in gas react here
 */
...
export default (options) => {
  ...
  return es.map((file, cb) => {
    try {
      let { document } = new JSDOM(String(file.contents)).window;
